<template>
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true">
                <el-form-item>
                    <el-input v-model="filtersKeyword" placeholder="电表编号/合同编号"></el-input>
                </el-form-item>
                <el-form-item>
                ...
                <el-form-item>
                    <el-upload
                            class="upload-demo"
                            action="/api/electricMeter/record/upload"
        ...
        <electric-meter-list ref="meterList" :filtersKeyword="filtersKeyword"></electric-meter-list>
    </section>
</template>

<script>
    import ElectricMeterList from "@/views/meter/ElectricMeterList";

    export default {
        name: "ElectricMeter",
        components: {ElectricMeterList},
        data() {
            return {
                loading: false,
                filtersKeyword: ''
